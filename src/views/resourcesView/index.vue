        ...
        <main class="container">
            <section class="uploader" :class="{ collapsed: uploaderCollapsed }">
                ...
                <form @submit.prevent="addResource" class="upload-form" :aria-hidden="uploaderCollapsed">
                    <div class="row">
                        <input v-model="form.title" type="text" placeholder="资源标题（必填，如果有解压码之类的也写这里吧）"
                            aria-label="资源标题" />
                    ...
                    <div class="row">
                        ...
                        <input v-model="form.link" type="url" placeholder="网盘链接(请选择好对应网盘且只输入网址不能有中文)"
                            aria-label="网盘链接" />
                    </div>
